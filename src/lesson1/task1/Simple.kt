...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int):
        Double = vershoks * 48 * 4.445 + arshins * 3 * 48 * 4.445 + sagenes * 1 * 3 * 48 * 4.445
...
fun accountInThreeYears(initial: Int, percent: Int):
        Double = ( initial * pow ( 100.0 + percent / 100, 3.0 ) )
...
fun numberRevert(number: Int):
        Int = ( number / 100 + number / 10 % 10 * 10 + number % 10 * 100 )
